      ...
      <div className="panel-body">
        ...
        >
          <div className="form-group">
            ...
            <label htmlFor="unit" className="col-sm-2 control-label">
          ...
          <div className="form-group">
            <label htmlFor="from-formatted" className="col-sm-2 control-label">
          ...
          <div className="form-group">
            ...
            <label htmlFor="expires_in" className="col-sm-2 control-label">
              {translate('offer_expiration_label')}
              <span style={{ color: 'red' }}>*</span>
            </label>
            <div className="col-sm-4">
              <Input type="text" name="expires_in" className="form-control" />
            </div>
          </div>
