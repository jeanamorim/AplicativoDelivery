...
export default function EditVariacao() {
  ...
  async function handleEditSubmit(data) {
    ...
    try {
      ...
      const idOpcao = response.data.id;

      await api.put(`variacao/${id}`, {
        name: variacao.name,
        mminimo: variacao.minimo,
        maximo: variacao.maximo,
        opcao: [...pegaId, idOpcao],
      });

      const responses = await api.get(`variacaoedit/${id}`);
      setOpcao(responses.data[0].opcao);
                      ...
                      <div className="modal-dialog" role="document">
                        ...
                        >
                          ...
                          <div className="modal-body">
                            <Form id="vd-formm" onSubmit={handleEditSubmit}>
                              <div className="form-group">
                                <label
                                  htmlFor="name"
