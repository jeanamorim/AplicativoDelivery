    ...
    <div className="content-wrapper" style={{ marginTop: 40 }}>
      <div className="panel-body">
        ...
        <Container>
          ...
          <ul>
            <Time>
              <strong>{formatPrice(status.valorTotal) || loading}</strong>
              <span>VALOR TOTAL</span>
            </Time>

            <Time>
              <strong>{formatPrice(status.totalDinheiro) || loading}</strong>
              <span>DINHEIRO</span>
            </Time>
            <Time>
              <strong>{formatPrice(status.totalCartao) || loading}</strong>
              <span>CARTÃO</span>
            </Time>

            <Time>
              <strong>{formatPrice(status.valorTotalFrete) || loading}</strong>
          ...
          <Content>
            <ul>
              ...
              <li>
                ...
                <strong>{formatPrice(porcentagemApp) || loading}</strong>
              </li>
            </ul>
          </Content>
